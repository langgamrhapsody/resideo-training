    ...
    <div class="featured-agents__container container">
        <div class="featured-agents__content">
            ...
            <div class="featured-agents__content-row row">
                <div class="featured-agents__content-item col-3">
                    <div class="featured-agents__content-item-card--first">
                        <a href="#" class="btn featured-agents__content-item-card-agent">
                            ...
                            <div class="agent-contact">
                                ...
                                <p class="agent-contact__number">(123) 456-7890</p>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="featured-agents__content-item col-3">
                    <div class="featured-agents__content-item-card--second"></div>
                </div>
                <div class="featured-agents__content-item col-3">
                    <div class="featured-agents__content-item-card--third"></div>
                </div>
                <div class="featured-agents__content-item col-3">
                    <div class="featured-agents__content-item-card--fourth"></div>
                </div>
            </div>
